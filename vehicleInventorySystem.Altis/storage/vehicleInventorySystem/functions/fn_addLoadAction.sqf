...
_caller addAction ["Load Inventory", {params ["_target", "_caller", "_actionId", "_arguments"]; uiNameSpace setVariable["vehicleToLoad", _target]; createDialog "loadDialog";}, nil, -100, false, false, "", '[_originalTarget] call ("VIS_fnc_ArsenalNearby" call cfgF)', 10, false];
