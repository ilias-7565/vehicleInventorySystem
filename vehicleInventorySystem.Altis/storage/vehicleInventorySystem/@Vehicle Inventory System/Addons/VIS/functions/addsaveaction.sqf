...
_caller addAction ["Save Inventory", {params ["_target", "_caller", "_actionId", "_arguments"]; uiNameSpace setVariable["vehicleToSave", _target]; createDialog "saveDialog";}, nil, -100, false, false, "", "[_originalTarget] call fatLurch_fnc_ArsenalNearby", 10, false];
