class loadDialog
{
	...
	class Controls
	{
		...
		class Combo
		{
			...
			onLBSelChanged="[] call fatLurch_fnc_loadListChange";
			onSetFocus="[] spawn fatLurch_fnc_initLoadDialog";
		...
		class Load
		{
			...
			onMouseButtonUp="[] call fatLurch_fnc_loadDialogClose";
			shadow=0;
		...
		class Edit
		{
			...
			onMouseButtonUp="[] spawn fatLurch_fnc_initEditDialog";
			shadow=0;
...
class saveDialog
{
	...
	class Controls
	{
		...
		class Save
		{
			...
			onMouseButtonUp="[] call fatLurch_fnc_saveDialogClose";
			shadow=0;
		...
		class Image
		{
			...
			font="PuristaMedium";
			sizeEx="(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1)";
			onLoad="[] spawn fatLurch_fnc_initSaveDialog";
		};
		class TextIn
		{
			type=2;
...
class editDialog
{
	...
	class Controls
	{
		...
		class Combo
		{
			...
			wholeHeight=0.30000001;
			onLBSelChanged="[] call fatLurch_fnc_editListChange";
			class ComboScrollBar
			{
				color[]={1,1,1,1};
				thumb="\A3\ui_f\data\gui\cfg\scrollbar\thumb_ca.paa";
		...
		class Delete
		{
			...
			onMouseButtonUp="[lbCurSel 7000] call fatLurch_fnc_editDialogClose";
			shadow=0;
...
class CfgFunctions
{
	class fatLurch
	{
		class VIS
		{
			...
			{
				file="VIS\functions\getFullInventory.sqf";
			};
			class loadFullInventory
			{
				file="VIS\functions\loadFullInventory.sqf";
			};
			class arsenalNearby
			{
				file="VIS\functions\arsenalNearby.sqf";
			};
			class initLoadDialog
			{
				file="VIS\functions\initLoadDialog.sqf";
			};
			class loadDialogClose
			{
				file="VIS\functions\loadDialogClose.sqf";
			};
			class loadListChange
			{
				file="VIS\functions\loadListChange.sqf";
			};
			class addLoadAction
			{
				file="VIS\functions\addLoadAction.sqf";
			};
			class saveDialogClose
			{
				file="VIS\functions\saveDialogClose.sqf";
			};
			class addSaveAction
			{
				file="VIS\functions\addSaveAction.sqf";
			};
			class initSaveDialog
			{
				file="VIS\functions\initSaveDialog.sqf";
			};
			class calcWeight
			{
				file="VIS\functions\calcWeight.sqf";
			};
			class initEditDialog
			{
				file="VIS\functions\initEditDialog.sqf";
			};
			class editDialogClose
			{
				file="VIS\functions\editDialogClose.sqf";
			};
			class editListChange
			{
				file="VIS\functions\editListChange.sqf";
			};
		};
	};
};
class Extended_Init_EventHandlers
{
	class air
	{
		...
		{
			init="(_this select 0) call fatLurch_fnc_addLoadAction;(_this select 0) call fatLurch_fnc_addSaveAction;";
		};
	};
	class car
	{
